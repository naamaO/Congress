...
export class ShopingCartHebrewComponent implements OnInit {
            ...
            this.serverService.getUserDetails().subscribe((events) => {
              ...
              if (this.IsMemberShip) {
                ...
                if (this.Total > 0) {
                  ...
                  this.TotalAfterDiscountUSD = 0;
                  this.TotalAfterDiscountILS = 0;
                }
              }
            })
          }
          ...
          if (this.DB.length > 0) {
            for (var i = 0; i < this.DB.length; i++) {
              if (this.DB[i].SallePrice == 0) {
                ...
                this.DB[i].TotalUSD = this.DB[i].PriceUSD * this.DB[i].Quantity;
                this.DB[i].TotalILS = this.DB[i].PriceILS * this.DB[i].Quantity;
                this.num = this.num + this.DB[i].Quantity;

                this.Total = this.Total + this.DB[i].Total;
                this.TotalUSD = this.TotalUSD + this.DB[i].TotalUSD;
                this.TotalILS = this.TotalILS + this.DB[i].TotalILS;
                if (this.Total > 0) {
                  this.getDiscountTotal(this.Total, this.TotalUSD, this.TotalILS);
                }
                else {
      ...
      for (var i = 0; i < this.DB.length; i++) {
        ...
        if (act == 'inc') {
          ...
          if (this.DB[i].SallePrice == 0) {
            ...
            this.TotalUSD = this.TotalUSD + this.DB[i].PriceUSD;
            this.TotalILS = this.TotalILS + this.DB[i].PriceILS;
            if (this.Total > 0) {
              this.getDiscountTotal(this.Total, this.TotalUSD, this.TotalILS);
            }
            else {
            ...
            this.TotalUSD = this.TotalUSD + this.DB[i].SalePriceUSD;
            this.TotalILS = this.TotalILS + this.DB[i].SalePriceILS;
            if (this.Total > 0) {
              this.getDiscountTotal(this.Total, this.TotalUSD, this.TotalILS);
            }
            else {
          ...
          if (this.itemToRedQunt1) {
            if (!this.rem) {
              ...
              this.TotalUSD = this.TotalUSD - this.itemToRedQunt1.TotalUSD;
              this.TotalILS = this.TotalILS - this.itemToRedQunt1.TotalILS;
              if (this.Total > 0) {
                this.getDiscountTotal(this.Total, this.TotalUSD, this.TotalILS);
              }
              else {
          ...
          if (this.itemToAddQunt1.SallePrice == 0) {
            ...
            for (var k = 0; k < this.DB.length; k++) {
              if (this.DB[k].Id == this.itemToAddQunt1.Id) {
                ...
                this.DB[k].TotalUSD = this.itemToAddQunt1.PriceUSD * this.itemToAddQunt1.Quantity;
                this.DB[k].TotalILS = this.itemToAddQunt1.PriceILS * this.itemToAddQunt1.Quantity;
              }
            }
            //this.DB.map(item => {
            //  if (item.Id === d)
            ...
            this.TotalUSD = this.TotalUSD + this.itemToAddQunt1.PriceUSD;
            this.TotalILS = this.TotalILS + this.itemToAddQunt1.PriceILS;
            ...
            for (var k = 0; k < this.DB.length; k++) {
              if (this.DB[k].Id == this.itemToAddQunt1.Id) {
                ...
                this.CART.contents[k].TotalUSD = this.DB[k].TotalUSD;
                this.CART.contents[k].TotalILS = this.DB[k].TotalILS;
              }
            ...
            for (var k = 0; k < this.DB.length; k++) {
              if (this.DB[k].Id == this.itemToAddQunt1.Id) {
                ...
                this.DB[k].TotalUSD = this.itemToAddQunt1.SalePriceUSD * this.itemToAddQunt1.Quantity;
                this.DB[k].TotalILS = this.itemToAddQunt1.SalePriceILS * this.itemToAddQunt1.Quantity;
              }
            }
            //this.DB.map(item => {
            //  if (item.Id === d)
            ...
            this.TotalUSD = this.TotalUSD + this.itemToAddQunt1.SalePriceUSD;
            this.TotalILS = this.TotalILS + this.itemToAddQunt1.SalePriceILS;
            if (this.Total > 0) {
              this.getDiscountTotal(this.Total, this.TotalUSD, this.TotalILS);
            }
            else {
          ...
          if (this.itemToRedQunt1) {
            ...
            if (!this.rem) {
              if (this.itemToRedQunt1.SallePrice == 0) {
                ...
                this.TotalUSD = this.TotalUSD - this.itemToRedQunt1.PriceUSD;
                this.TotalILS = this.TotalILS - this.itemToRedQunt1.PriceILS;
                if (this.Total > 0) {
                  this.getDiscountTotal(this.Total, this.TotalUSD, this.TotalILS);
                }
                else {
                ...
                this.TotalUSD = this.TotalUSD - this.itemToRedQunt1.SalePriceUSD;
                this.TotalILS = this.TotalILS - this.itemToRedQunt1.SalePriceILS;
                if (this.Total > 0) {
                  this.getDiscountTotal(this.Total, this.TotalUSD, this.TotalILS);
                }
                else {
  ...
  add(item, qty = 1) {
    ...
    if (this.find(item.IdBook)) {
      ...
      let obj = {
        ...
        SalePriceILS: item.SalePriceILS
      };
  ...
  SendToTranzila() {
    ...
    this.serverService.getNameHebrew(this.UserNameLogin).subscribe((val) => {
      let first: any;
      let last: any
      first = val.FirstNameHebrew || val.FirstName;
      last = val.LastNameHebrew || val.LastName;
      let contactName: any;
