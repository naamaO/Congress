...
@Component({
  selector: 'app-shopping-cart-only-one-hebrew',
  templateUrl: './shopping-cart-only-one-hebrew.component.html',
  styleUrls: ['./shopping-cart-only-one-hebrew.component.css']
})
export class ShoppingCartOnlyOneHebrewComponent implements OnInit {
  ...
  SendToSignIn() {
    this.router.navigateByUrl("/UserPass/2222");
  }
  isSignIn() {
    //this.UserNameLogin = this.getCookie('UserName'); 
    if (this.getCookie('UserName') != undefined) {
