...
@Component({
  selector: 'app-user-pass-from-store',
  templateUrl: './user-pass-from-store.component.html',
  styleUrls: ['./user-pass-from-store.component.css']
})
export class UserPassFromStoreComponent implements OnInit {
