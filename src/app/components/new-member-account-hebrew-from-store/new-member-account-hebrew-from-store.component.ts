...
@Component({
  selector: 'app-new-member-account-hebrew-from-store',
  templateUrl: './new-member-account-hebrew-from-store.component.html',
  styleUrls: ['./new-member-account-hebrew-from-store.component.css']
})
export class NewMemberAccountHebrewFromStoreComponent implements OnInit {
  ...
  SendToSignIn() {
    this.router.navigateByUrl("/UserPassHebrew/2222");
  }
  SendToNewMember() {
