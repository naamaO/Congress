...
@Component({
  selector: 'app-information-from-store',
  templateUrl: './information-from-store.component.html',
  styleUrls: ['./information-from-store.component.css']
})
export class InformationFromStoreComponent implements OnInit {
