...
@Component({
  selector: 'app-user-pass-hebrew-from-store',
  templateUrl: './user-pass-hebrew-from-store.component.html',
  styleUrls: ['./user-pass-hebrew-from-store.component.css']
})
export class UserPassHebrewFromStoreComponent implements OnInit {
