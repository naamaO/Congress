...
@Component({
  selector: 'app-new-member-account-from-store',
  templateUrl: './new-member-account-from-store.component.html',
  styleUrls: ['./new-member-account-from-store.component.css']
})
export class NewMemberAccountFromStoreComponent implements OnInit {
